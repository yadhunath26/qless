...
BLEServer* pGlobalServer = nullptr;  // kept globally for re-advertising
...
CartItem items[] = {
  ...
  { "Eggs",   "F753F105", 60,  0 },
  { "Milk",   "6DEEB101", 40,  0 },
  { "Butter", "A4C10902", 55,  0 },
  { "Jam",    "6B08B701", 90,  0 },
  { "Kinder Joy",  "CC990E02", 45,  0 },
  { "Bourbon",     "6A6CB601", 10,  0 },
  { "Dairy Milk",  "CD90B701", 10,  0 },
  { "Sugar",       "E58B0A02", 30,  0 },
...
void clearCart() {
  ...
  Serial.println("Cart cleared! Restarting ESP32 to reset BLE...");
  delay(1500);  // let app receive any final BLE data
  ESP.restart(); // full restart = fresh BLE advertising automatically
}
...
class MyServerCallbacks : public BLEServerCallbacks {
  ...
  void onDisconnect(BLEServer* pServer) {
    ...
    // Small delay then restart advertising so phone can reconnect
    // Do NOT clear cart here — CLEAR command from app handles that
    delay(500);
...
void setup() {
  ...
  pGlobalServer = pServer;  // save globally
